...
<div class="max-w-2xl mx-auto px-6 py-12">
    ...
    <h1 class="text-3xl font-black text-slate-900 dark:text-white mb-8">Add New Crop</h1>
    ...
    <form action="{{ route('admin.crops.store') }}" method="POST" class="stat-card space-y-5">
        @csrf
        @include('admin.crops._form', ['crop' => null])
